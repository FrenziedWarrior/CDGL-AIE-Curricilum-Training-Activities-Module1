...
# Draw a Magenta-bordered rectangle
...
cv2.circle(image_rgb, (center1_x, center1_y), 15, COLOR_ORANGE, -1)
...
# Draw a filled Green cicle
cv2.circle(image_rgb, (center2_x, center2_y), 15, COLOR_PURPLE, -1)
...
cv2.line(image_rgb, (center1_x, center1_y), (center2_x, center2_y), COLOR_CYAN, 3)
...
cv2.putText(image_rgb, "Region 2", (top_left2[0], top_left2[1] - 10), font, 0.7, COLOR_WHITE, 2, cv2.LINE_AA)
cv2.putText(image_rgb, "Center 1", (center1_x - 40, center1_y + 40), font, 0.6, COLOR_ORANGE, 2, cv2.LINE_AA)
cv2.putText(image_rgb, "Center 2", (center2_x - 40, center2_y + 40), font, 0.6, COLOR_PURPLE, 2, cv2.LINE_AA)
...
cv2.putText(image_rgb, f"Height: {height}px", height_label_position, font, 0.8, COLOR_YELLOW, 2, cv2.LINE_AA)

# cv2.imshow("bgr-image in BGR-color-space", image_rgb)
# cv2.waitKey(0)
